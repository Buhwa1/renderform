  ...
  <div className="home">
    ...
    <section className="hero">
        <div className="announce">
          ...
          <p>Introducing Renderform 2.0</p>
        </div>
        <h1>Build beautiful spaces at the speed of thought using renderform</h1>
        <p className="subtitle">
          Rennderform is an AI-first design environment that helps you visualize,render and ship architectural projects faster than ever.
        </p>
